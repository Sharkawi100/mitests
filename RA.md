...
- مصادر المحتوى: رفع ملف / توليد AI / اختبار بدون نص (توليد AI مباشر).
...
- إذا وجد:
  - تعارض مباشر (تداخل زمني).
  - أو موعد قريب من الاختبار (ضمن نافذة تحذير تشغيلية).
  يجب عرض تنبيه واضح للمعلم قبل المتابعة.
